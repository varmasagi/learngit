...
export interface CfnIdentitySourceProps {
     ...
     * > You must specify a `userPoolArn` , and optionally, a `ClientId` .
     *
     * This data type is used as a request parameter for the [CreateIdentitySource](https://docs.aws.amazon.com/API_CreateIdentitySource.html) operation.
     *
     ...
     * Specifies the ID of the in which you want to store this .
     *
     * Only policies and requests made using this can reference identities from the identity provider configured in the new .
     *
